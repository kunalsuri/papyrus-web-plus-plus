...
> Full catalog generated by `/create-feature-catalog` on 2026-07-07 (17 features F1–F17, API
> surface, touch lists): see `ai/analysis/FEATURE_CATALOG.md` + its backend/frontend splits.
