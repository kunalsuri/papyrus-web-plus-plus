...
> Generated mechanically by ai-fication-kit `verify` on 2026-06-29.
...
|---|---|---|
| confirmed | 120 | claim found on disk |
...
120 confirmed claim(s) — full list in VERIFICATION_MANIFEST.json.
