...
>
> **Cold-start snapshot — 2026-06-29** (commit `<commit-hash>`), once generated.
>
...
Depending on the complexity of papyrus-web-plus-plus, the catalog can live in a single file or be split to reduce token context overhead:
