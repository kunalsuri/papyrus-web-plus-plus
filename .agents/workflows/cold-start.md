...
5. **Draft diagrams into `ai/analysis/diagrams/`** as Mermaid `.mmd`:
...
6. **Note candidate features** in `ai/guide/FEATURE_MAP.md` using its template.
7. **Update `ai/guide/ARCHITECTURE.md` and `PROJECT_OVERVIEW.md`** only where you
   VERIFIED something in code or config.
8. **Apply the hard rules for this pass:**
...
9. **Stop and report.** Print an "AUDIT TODO" table (columns: # · Location · What to
