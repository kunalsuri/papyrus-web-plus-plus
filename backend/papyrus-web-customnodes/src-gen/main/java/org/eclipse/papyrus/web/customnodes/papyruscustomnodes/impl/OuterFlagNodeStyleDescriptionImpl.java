 ...
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.OuterFlagNodeStyleDescriptionImpl#getDescription
...
public class OuterFlagNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements OuterFlagNodeStyleDescription {
    ...
    public void setDescription(String newDescription) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.OUTER_FLAG_NODE_STYLE_DESCRIPTION__DESCRIPTION, oldDescription, this.description));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case PapyrusCustomNodesPackage.OUTER_FLAG_NODE_STYLE_DESCRIPTION__DESCRIPTION:
