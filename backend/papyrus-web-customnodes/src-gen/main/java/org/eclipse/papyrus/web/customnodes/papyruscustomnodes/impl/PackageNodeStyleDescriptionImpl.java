 ...
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.PackageNodeStyleDescriptionImpl#getDescription
...
public class PackageNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements PackageNodeStyleDescription {
    ...
    public void setDescription(String newDescription) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.PACKAGE_NODE_STYLE_DESCRIPTION__DESCRIPTION, oldDescription, this.description));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case PapyrusCustomNodesPackage.PACKAGE_NODE_STYLE_DESCRIPTION__DESCRIPTION:
