 ...
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.CuboidNodeStyleDescriptionImpl#getDescription
...
public class CuboidNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements CuboidNodeStyleDescription {
    ...
    public void setDescription(String newDescription) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.CUBOID_NODE_STYLE_DESCRIPTION__DESCRIPTION, oldDescription, this.description));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case PapyrusCustomNodesPackage.CUBOID_NODE_STYLE_DESCRIPTION__DESCRIPTION:
