 ...
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.CustomImageNodeStyleDescriptionImpl#getDescription
...
public class CustomImageNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements CustomImageNodeStyleDescription {
    ...
    public void setDescription(String newDescription) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.CUSTOM_IMAGE_NODE_STYLE_DESCRIPTION__DESCRIPTION, oldDescription, this.description));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case PapyrusCustomNodesPackage.CUSTOM_IMAGE_NODE_STYLE_DESCRIPTION__DESCRIPTION:
