...
public final class DDMappingTypes {
    ...
    public static String getMappingType(EClass eClass) {
        String suffix = switch (eClass.getName()) {
            case "Model", "Node", "Package", "Device", "ExecutionEnvironment", "Artifact" -> "_Holder";
            default -> "";
        };
        String result = DD_PREFIX + eClass.getName() + suffix;
    ...
    public static String getMappingTypeAsSubNode(EClass eClass) {
        ...
        String result = DD_PREFIX + eClass.getName() + "_SHARED" + suffix;
        return result;
    }
