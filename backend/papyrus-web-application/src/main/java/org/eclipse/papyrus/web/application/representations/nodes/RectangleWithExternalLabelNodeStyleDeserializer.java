 ...
 */
@Service
public class RectangleWithExternalLabelNodeStyleDeserializer implements ICustomNodeStyleDeserializer {

    @Override
    public boolean canHandle(String type) {
        return type.equals(RectangleWithExternalLabelNodeStyleProvider.NODE_RECTANGLE_WITH_EXTERNAL_LABEL);
    }

    @Override
    public INodeStyle handle(ObjectNode root, JsonParser jsonParser, DeserializationContext context) throws JacksonException {
        return context.readTreeAsValue(root, RectangleWithExternalLabelNodeStyle.class);
    }
}
