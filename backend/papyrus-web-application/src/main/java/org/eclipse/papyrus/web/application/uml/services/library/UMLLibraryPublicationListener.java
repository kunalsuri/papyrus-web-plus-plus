...
import org.eclipse.sirius.web.application.studio.services.library.StudioLibraryPublicationListener;
 ...
 *
 * Adapted from StudioLibraryPublicationListener and SysONLibraryPublicationListener
 *
 * @author Vincent LORENZO
 */
@Service
public class UMLLibraryPublicationListener {
    ...
    public UMLLibraryPublicationListener(ILibraryCreationService libraryCreationService, IProjectEditingContextService projectEditingContextService) {
    ...
    public void onSemanticDataCreatedEvent(SemanticDataCreatedEvent semanticDataCreatedEvent) {
        if (semanticDataCreatedEvent.causedBy() instanceof UMLLibrarySemanticDataCreationRequested request && request.causedBy() instanceof PublishLibrariesInput publishLibrariesInput) {
