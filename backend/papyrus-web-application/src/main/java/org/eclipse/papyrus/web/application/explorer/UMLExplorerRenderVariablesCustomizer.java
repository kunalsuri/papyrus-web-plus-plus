...
/**
 * Provides additional render variables to be used by UML Default Explorer to reduce the amount of duplicate work
 * (notably database access):
 *
 * <dl>
 * <dt>{@code existingRepresentations}
 * <dt>
 ...
 */
@Service
public class UMLExplorerRenderVariablesCustomizer implements IRepresentationRenderVariableCustomizer {

    private final IRepresentationMetadataSearchService representationMetadataSearchService;

    public UMLExplorerRenderVariablesCustomizer(IRepresentationMetadataSearchService representationMetadataSearchService) {
    ...
    public VariableManager customize(IRepresentationDescription representationDescription, VariableManager variableManager) {
        if (UMLDefaultTreeDescriptionBuilder.UML_EXPLORER.equals(representationDescription.getLabel())) {
            ...
            if (optionalEditingContext.isPresent()) {
                ...
                List<RepresentationMetadata> allRepresentationMetadata = this.representationMetadataSearchService
                        .findAllRepresentationMetadataBySemanticData(AggregateReference.to(optionalSemanticDataId.get()));
